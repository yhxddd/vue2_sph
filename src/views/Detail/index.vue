        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuAttr in spuSaleAttrList" :key="spuAttr.id">
                <dt class="title">{{spuAttr.saleAttrName}}</dt>
                <dd v-for="sale in spuAttr.spuSaleAttrValueList" 
                    :key="sale.id" changepirce="0" 
                    :class="sale.isChecked == '1' ? 'active':''"
                    @click="changeActive(sale, spuAttr.spuSaleAttrValueList)">
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.$store.dispatch('reqGoodsDetail', this.$route.params.skuid)
    },
    computed:{
